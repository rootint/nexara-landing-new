<script>
	...
	import { Cloud, Navigation, Server, ShieldCheck } from 'lucide-svelte';
</script>
...
<section class="features" id="features">
	...
	<div class="cards">
		<div class="card-row">
			<div class="card">
				<p class="top-desc">Транскрибация 1 часа аудио</p>
				<div class="bars-container">
					<div class="result-row">
						<div class="bar-nexara" style="width: 100px;">Nexara</div>
						<p class="bar-text-nexara">15 секунд</p>
					</div>
					<div class="result-row">
						<div class="bar" style="width: 290px;">OpenAI</div>
						<p class="bar-text">102 секунды</p>
					</div>
					<div class="result-row">
						<div class="bar" style="width: 300px;">Yandex SpeechKit</div>
						<p class="bar-text">122 секунды</p>
					</div>
					<div class="result-row">
						<div class="bar" style="width: 410px;">Sber SaluteSpeech</div>
						<p class="bar-text">288 секунд</p>
					</div>
				</div>
				<h3 class="card-title">Высокая скорость</h3>
				<p class="card-desc">В 8 раз быстрее Yandex SpeechKit и 6 раз быстрее OpenAI API.</p>
			</div>
            ...
            <div class="card">
				...
				<div class="bars-container">
					<div class="setting-row">
						...
						<!-- <div class="bar-nexara" style="width: 100px;">On-Premise</div> -->
						<p>On-Premise</p>
					</div>
					<div class="setting-row">
						<Server></Server>
						<!-- <div class="bar" style="width: 290px;">Выделенные сервера</div> -->
						<p>Выделенные сервера</p>
					</div>
					<div class="setting-row">
						<Cloud></Cloud>
						<!-- <div class="bar" style="width: 300px;">Облачный API</div> -->
						<p>Облачный API</p>
					</div>
				</div>
